scoreboard objectives add tmmw.stats dummy

#cooldown - The cooldown inbetween shots.
scoreboard objectives add tmmw.cd dummy
scoreboard players add @a tmmw.cd 0

#autodelay - Auto-Delay is the delay inbetween Auto-Fire Shots.
scoreboard objectives add tmmw.ad dummy
